    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 p-4">
      <div className="w-full max-w-sm rounded-3xl border border-white/10 bg-white/[0.03] p-8 shadow-2xl backdrop-blur-2xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-semibold text-slate-100">Connexion</h1>
          <p className="mt-1 text-sm text-slate-500">Smart Resource Manager</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-500">
          Pas encore de compte ? <Link to="/register" className="font-medium text-cyan-400 hover:text-cyan-300">S'inscrire</Link>
        </p>
      </div>
    </div>
  );
